...
then
    ...
    echo $TRUSTSTORE_PASSWORD > ${TRUSTSTORE_PASSWORD_FILE:-/tls-certs/truststore.password}
...
then
    ...
    echo $KEYSTORE_PASSWORD > ${KEYSTORE_PASSWORD_FILE:-/tls-certs/keystore.password}
